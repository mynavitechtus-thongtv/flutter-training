...
void main() {
  ...
  group('isValidEmail', () {
    test('when email is nn@gn.co', () {
      final isValid = AppUtil.isValidEmail('nn@gn.co');

      expect(isValid, equals(true));
    });

    test('when email is nn@gn.co.vn', () {
      final isValid = AppUtil.isValidEmail('nn@gn.co.vn');
    ...
    test('when email does not contain @', () {
      final isValid = AppUtil.isValidEmail('nngn.com');

      expect(isValid, equals(false));
    });

    test('when email does not contain .', () {
      final isValid = AppUtil.isValidEmail('nn@gnco');
